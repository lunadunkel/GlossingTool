...
def clone_and_load_data(config: 'DataConfig', clone: bool = True, 
                        data_path: Optional[str] = None) -> Tuple[List, List, List]:
    ...
    if clone:
        load_dotenv()
        # logger = get_logger(__name__, separate_file=False)
        # logger.info("Клонирование приватного репозитория NivkhTxt")
